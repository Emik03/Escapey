...
#pragma warning disable SA1602 // ReSharper disable UnusedMember.Local
partial interface IInputProvider
{
    sealed partial class Evdev
    {
        /// <summary>Contains input event codes related to any key or button.</summary>
        // ReSharper disable IdentifierTypo
        enum KeyEventCodes : ushort
        {
            KEY_RESERVED = 0,
            KEY_ESC = 1,
            KEY_1 = 2,
